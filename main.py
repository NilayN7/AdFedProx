...
if __name__ == "__main__":
    ...
    parser.add_argument("--setting", type=str, default="non-iid")
    ...
    model_f, loss_hist_FA, acc_hist_FA = FedProx( 
        ...
        mnist_test_dls, epochs=args.epochs, lr=args.lr, mu=0
    )

    # FedProx
    model_f, loss_hist_FP, acc_hist_FP = FedProx( 
        model_0, mnist_train_dls, args.n_iter, 
        mnist_test_dls, epochs=args.epochs, lr=args.lr, mu=0.3)

    # comparison
    plot_acc_loss("FedAvg MNIST-iid", loss_hist_FA, acc_hist_FA)
